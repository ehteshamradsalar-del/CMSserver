/*
  ...
  - The values [CURATOR_ONLY] on the enum `Visibility` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Visibility_new" AS ENUM ('PUBLIC', 'PRIVATE');
ALTER TABLE "public"."Artwork" ALTER COLUMN "visibility" DROP DEFAULT;
...
ALTER TABLE "Artwork" ALTER COLUMN "visibility" TYPE "Visibility_new" USING ("visibility"::text::"Visibility_new");
...
ALTER TABLE "Artwork" ALTER COLUMN "visibility" SET DEFAULT 'PUBLIC';
